...
export const CubeStoreContext = createContext<CubeStoreApi | undefined>(
    undefined,
)
...
export const CubeStoreProvider = ({
    ...
    return (
        <CubeStoreContext.Provider value={storeRef.current}>
            {children}
        </CubeStoreContext.Provider>
    )
}

export const useCubeStore = <T,>(
    selector: (store: CubeStore) => T,
): T => {
