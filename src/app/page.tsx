...
export default async function Home() {
	...
	return (
		<HydrateClient>
			<Shell session={session} title="max809.de" withLoginButton>
				<ShowcaseGrid mainTitle={appsOnPage.mainTitle} elements={appsOnPage.elements} />
				<ShowcaseGrid mainTitle={otherApps.mainTitle} elements={otherApps.elements} />
				<ShowcaseGrid mainTitle={githubStats.mainTitle} elements={githubStats.elements} />
				<Box className=""></Box>
			</Shell>
		</HydrateClient>
	);
