							...
							<>
								...
								>
									<Stack gap={5}>
										...
										<Box w={"100%"} style={{ borderRadius: "5px" }} p={"sm"} c={"#fa2113"} bg={"#0D1117"} hidden={!error}>
											{error?.message}
										</Box>
									</Stack>
								</Modal>
							...
							<Stack>
								...
								<Stack gap={0} m={0}>
									...
									<Text c={"dimmed"} fw={500} inline fz={"sm"}>
										These options are for advanced users only. Options with * may stop the QR Code from being scanned by some
										scanners.
									</Text>
									<Stack gap={0} mt={15}>
										<Text size="sm" fw={500}>
									...
									<Group justify="space-between" grow>
										<Stack mt={15} gap={0}>
											...
											<Text size="sm">Value: {finderRadius.toFixed(1)}</Text>
											<Slider mt={15} value={finderRadius} onChange={setFinderRadius} min={0} max={1} step={0.1} />
										</Stack>
										<Stack mt={15} gap={0}>
											<Group p={0} wrap="nowrap" gap={1}>
												<Text size="sm" fw={500}>
											...
											<Text size="sm">Value: {finderRadius.toFixed(1)}</Text>
											<Slider mt={15} value={dotRadius} onChange={setDotRadius} min={0} max={1} step={0.1} />
										</Stack>
									</Group>
								</Stack>
							</Stack>
