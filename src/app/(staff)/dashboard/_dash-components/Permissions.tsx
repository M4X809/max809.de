...
const Permissions = ({ session, permissions, user }: { session: Session | null | undefined, permissions: PermissionsType[], user: User }) => {
            ...
            const subPerms = perm?.children?.map((perm) => {
                return (
                    ...
                    >
                            ...
                            <Group wrap="nowrap" justify="space-between">
                                ...
                                >
                                    <Group wrap="nowrap" px={5} ta={"center"} >
                                        <Code className="bg-[rgba(0,0,0,0.25)]  rounded-md" c={color(perm)}>
                                            <Text truncate fz={14}>
                                                {perm.perm}
                                            </Text>
                                        </Code>
                        ...
                        <Grid.Col span={"auto"}>
                            <Flex justify={"center"} align={"center"} h={"100%"} className={twMerge("cursor-pointer", perm.disabled && "cursor-not-allowed")}>
                                <Checkbox
                                    classNames={{
